...
['dev', 'dist'].forEach(function (env) {
    injectPaths[env] = injectLibsPaths[env].concat([
        ...
        isDist ? destinations.js + '/appts.js' : destinations.js + "/app/**/*.js",
...
gulp.task('ts-compile', function () {
    ...
    return tsResult.js.pipe(isDist ? $.concat('appts.js') : $.util.noop())
...
gulp.task('watch', function () {
    ...
    gulp.watch(globs.js, gulp.series('js-compile'));
...
gulp.task(
    ...
    gulp.series(
        'clean',
        gulp.parallel('sass', 'copy-assets', 'js-compile', 'ts-compile','templates', 'copy-vendor'),
        'index'
    )
);
